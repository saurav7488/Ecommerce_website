...
const Top_stories = ({ endpoint: { title, news } }) => {
          ...
          <Splide options={splideOptions}>
            {news.map((val, i) => (
              <SplideSlide key={i} className="mb-0.5">
                <div
                  className="relative grid items-center gap-4 pb-4 rounded-lg 
                ...
                >
                  ...
                  >
                    <img
                      ...
                      className="w-full h-auto 
                                     object-cover shadow-md shadow-slate-200 rounded-tl-lg 
                                     rounded-tr-lg "
                    />
                  </div>
                  <div className="flex items-center justify-between w-full px-4">
                    ...
                    <div className="flex items-center gap-0.5  ">
                      <ClockIcon className="icon-styl w-4 h-4 text-black " />
                  ...
                  <div className="flex items-center justify-items-center px-4 w-full">
                    <a target="_blank" role="button" href={val.url} className="w-full bg-slate-900 bg-gradient-to-b from-slate-900 
